...
Train a new network on a data set with train.py
    ...
    Options:
        ...
        Example python train.py flowers --gpu --learning_rate 0.001 --epochs 3
'''
...
def main():
    ...
    save_checkpoint(utils.basepath+arguments.save_dir,save_params_dict)
...
def do_deep_learning(processor, model, criterion, optimizer, epochs, trainloader, testloader):
    steps = 0
    print_every = 10
    ...
    for e in range(epochs):
        ...
        for ii, (inputs, labels) in enumerate(trainloader):
            ...
            if steps % print_every == 0:
                ...
                with torch.no_grad():
                    test_loss, accuracy = validation(model, testloader, criterion, processor)
